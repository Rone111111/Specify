...
<form id="cahier-form" style="max-width: 800px; margin-bottom: 2rem;">
  ...
  <label>1. Nom du projet<br><input type="text" name="Nom du projet" placeholder="Exemple : Tableau de bord des ventes 2024" required></label><br><br>

  <label>2. Objectif principal<br><input type="text" name="Objectif principal" placeholder="(Informer, convaincre, explorer, comparer, alerter, etc.)"></label><br><br>
